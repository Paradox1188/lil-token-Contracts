...
// Plugin settings
const LP_SYMBOL = "vLP-SCALE/WETH Gauge"; // Desired symbol for LP Gauge plugin
...
async function getContracts() {
  // pluginFactory = await ethers.getContractAt("contracts/plugins/base/ScaleGaugePluginFactory.sol:ScaleGaugePluginFactory", "0x0000000000000000000000000000000000000000");
  // plugin = await ethers.getContractAt("contracts/plugins/base/ScaleGaugePluginFactory.sol:ScaleGaugePlugin", "0x0000000000000000000000000000000000000000");
...
async function verifyPluginFactory() {
  ...
  await hre.run("verify:verify", {
    ...
    contract:
      "contracts/plugins/base/ScaleGaugePluginFactory.sol:ScaleGaugePluginFactory",
...
async function deployPlugin() {
  ...
  await pluginFactory.createPlugin(LP_ADDRESS, LP_SYMBOL, {
    gasPrice: ethers.gasPrice,
  });
  await sleep(5000);
